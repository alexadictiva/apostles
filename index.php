...
<section class="cards-main-view">
  <article class="card-main card1">
    <h2>PORTFOLIO</h2>
    <p>The Twelve Apostles Inc. portfolio covers a diverse range of brand categories. As the company represents multiple markets, our target end-consumer is to combine an excellent product with the best competitive price. </p>
  ...
  <article class="card-main card3">
    <h2>NETWORK</h2>
    <p>The Twelve Apostles Inc. has organized the logistic of the company, in different strategic locations in order to achieve regional integration and create an ideal resource for this kind of business.</p>
...
<section id="contactus">
    ...
    <div class="contactus-content">
      <div class="form-container">
        ...
        <p>For more information, complete
           the following form and we will contact you 
          shortly.</p>
        <form action="POST">
          ...
          <div class="form-control">
            <textarea name="message" id="message" cols="30" placeholder="Type your message here..." rows="10"></textarea>
          </div>
